...
from cg_dialog import CGResetDialog
import webbrowser
...
class MainWindow(QMainWindow):
    ...
    """
    # 默认画布的宽与高
    DEFAULT_W = MAINWINDOW_W - 100
    DEFAULT_H = MAINWINDOW_H - 100
    ...
    def __init__(self):
        ...
        save_act.setIcon(QIcon(RESOURCE_DIR + "save.png"))
        set_pen_menu = file_menu.addMenu('设置画笔')
        set_pen_menu.setFont(FONT)
        set_pen_menu.setIcon(QIcon(RESOURCE_DIR + "pen.png"))
        set_pen_color_act = set_pen_menu.addAction('画笔颜色')
        set_pen_color_act.setIcon(QIcon(RESOURCE_DIR + "set_color.png"))
        set_pen_width_act = set_pen_menu.addAction('画笔粗细')
        set_pen_width_act.setIcon(QIcon(RESOURCE_DIR + "set_width.png"))
        reset_canvas_act = file_menu.addAction('重置画布')
        reset_canvas_act.setIcon(QIcon(RESOURCE_DIR + "clear.png"))
        exit_act = file_menu.addAction('退出')
        exit_act.setIcon(QIcon(RESOURCE_DIR + "exit.png"))
        # 编辑栏
        edit_menu = menubar.addMenu('编辑')
        edit_menu.setFont(FONT)
        select_act = edit_menu.addAction('选择')
        select_act.setIcon(QIcon(RESOURCE_DIR + "select.png"))
        copy_act = edit_menu.addAction('复制')
        copy_act.setIcon(QIcon(RESOURCE_DIR + "copy.png"))
        paste_act = edit_menu.addAction('粘贴')
        paste_act.setIcon(QIcon(RESOURCE_DIR + "paste.png"))        
        translate_act = edit_menu.addAction('平移')
        translate_act.setIcon(QIcon(RESOURCE_DIR + "translate.png"))
        rotate_act = edit_menu.addAction('旋转')
        rotate_act.setIcon(QIcon(RESOURCE_DIR + "rotate.png"))
        scale_act = edit_menu.addAction('缩放')
        scale_act.setIcon(QIcon(RESOURCE_DIR + "scale.png"))
        clip_menu = edit_menu.addMenu('裁剪')
        clip_menu.setFont(FONT)
        clip_menu.setIcon(QIcon(RESOURCE_DIR + "clip.png"))
        ...
        line_menu.setIcon(QIcon(RESOURCE_DIR + "lines.png"))
        line_menu.setFont(FONT)
        line_naive_act = line_menu.addAction('Naive')
        line_dda_act = line_menu.addAction('DDA')
        line_bresenham_act = line_menu.addAction('Bresenham')
        polygon_menu = draw_menu.addMenu('多边形')
        polygon_menu.setIcon(QIcon(RESOURCE_DIR + "polygon.png"))
        polygon_menu.setFont(FONT)
        polygon_dda_act = polygon_menu.addAction('DDA')
        polygon_bresenham_act = polygon_menu.addAction('Bresenham')
        ellipse_act = draw_menu.addAction('椭圆')
        ellipse_act.setIcon(QIcon(RESOURCE_DIR + "ellipse.png"))
        curve_menu = draw_menu.addMenu('曲线')
        curve_menu.setIcon(QIcon(RESOURCE_DIR + "curve.png"))
        ...
        help_act.setIcon(QIcon(RESOURCE_DIR + "help.png"))
        # 连接信号和槽函数
        ...
        self.setWindowIcon(QIcon(RESOURCE_DIR + "paintIcon4.png"))
